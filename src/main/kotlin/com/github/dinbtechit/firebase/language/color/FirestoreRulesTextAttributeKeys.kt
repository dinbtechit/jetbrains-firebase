...
object FirestoreRulesTextAttributeKeys {
    ...
    val CLASS_NAME = createFireRuleAttributeKey("CLASS_NAME", DefaultLanguageHighlighterColors.CLASS_NAME)
    ...
    val PERMISSION_METHOD_TYPE = createFireRuleAttributeKey("PERMISSION_METHOD_TYPE", CLASS_NAME)
