...
public class PsiFirestoreRulesIfLogicImpl extends ASTWrapperPsiElement implements PsiFirestoreRulesIfLogic {

  public PsiFirestoreRulesIfLogicImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiFirestoreRulesVisitor visitor) {
    visitor.visitIfLogic(this);
  }
