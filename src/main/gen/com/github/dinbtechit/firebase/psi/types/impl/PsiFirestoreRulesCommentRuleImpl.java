...
public class PsiFirestoreRulesCommentRuleImpl extends ASTWrapperPsiElement implements PsiFirestoreRulesCommentRule {

  public PsiFirestoreRulesCommentRuleImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public PsiFirestoreRulesBlockCommentRule getBlockCommentRule() {
    return findChildByClass(PsiFirestoreRulesBlockCommentRule.class);
  }
