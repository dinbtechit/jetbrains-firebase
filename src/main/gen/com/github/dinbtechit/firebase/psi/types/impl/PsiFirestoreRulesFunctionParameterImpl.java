...
public class PsiFirestoreRulesFunctionParameterImpl extends ASTWrapperPsiElement implements PsiFirestoreRulesFunctionParameter {

  public PsiFirestoreRulesFunctionParameterImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public PsiFirestoreRulesVariableName getVariableName() {
    return findNotNullChildByClass(PsiFirestoreRulesVariableName.class);
  }
