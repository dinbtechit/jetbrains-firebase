...
public class PsiFirestoreRulesMatchBlockImpl extends ASTWrapperPsiElement implements PsiFirestoreRulesMatchBlock {

  public PsiFirestoreRulesMatchBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public PsiFirestoreRulesMatchBody getMatchBody() {
    return findChildByClass(PsiFirestoreRulesMatchBody.class);
  }

  @Override
  @Nullable
  public PsiFirestoreRulesMatchPath getMatchPath() {
    return findChildByClass(PsiFirestoreRulesMatchPath.class);
  }
