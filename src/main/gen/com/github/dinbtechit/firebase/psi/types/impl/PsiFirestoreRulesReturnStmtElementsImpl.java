...
public class PsiFirestoreRulesReturnStmtElementsImpl extends ASTWrapperPsiElement implements PsiFirestoreRulesReturnStmtElements {

  public PsiFirestoreRulesReturnStmtElementsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiFirestoreRulesVisitor visitor) {
    visitor.visitReturnStmtElements(this);
  }
