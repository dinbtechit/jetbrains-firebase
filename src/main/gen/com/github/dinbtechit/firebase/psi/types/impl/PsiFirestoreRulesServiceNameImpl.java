...
public class PsiFirestoreRulesServiceNameImpl extends ASTWrapperPsiElement implements PsiFirestoreRulesServiceName {

  public PsiFirestoreRulesServiceNameImpl(@NotNull ASTNode node) {
    super(node);
  }
