...
public class PsiFirestoreRulesObjectPropertyImpl extends ASTWrapperPsiElement implements PsiFirestoreRulesObjectProperty {

  public PsiFirestoreRulesObjectPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }
