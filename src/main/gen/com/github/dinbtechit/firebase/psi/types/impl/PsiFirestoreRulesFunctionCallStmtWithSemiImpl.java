...
public class PsiFirestoreRulesFunctionCallStmtWithSemiImpl extends ASTWrapperPsiElement implements PsiFirestoreRulesFunctionCallStmtWithSemi {

  public PsiFirestoreRulesFunctionCallStmtWithSemiImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiFirestoreRulesVisitor visitor) {
    visitor.visitFunctionCallStmtWithSemi(this);
  }
  ...
  public PsiFirestoreRulesFunctionCallStmt getFunctionCallStmt() {
    return findNotNullChildByClass(PsiFirestoreRulesFunctionCallStmt.class);
  }
