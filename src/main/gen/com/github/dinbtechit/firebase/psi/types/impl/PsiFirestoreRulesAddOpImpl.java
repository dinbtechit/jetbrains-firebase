...
public class PsiFirestoreRulesAddOpImpl extends ASTWrapperPsiElement implements PsiFirestoreRulesAddOp {

  public PsiFirestoreRulesAddOpImpl(@NotNull ASTNode node) {
    super(node);
  }
