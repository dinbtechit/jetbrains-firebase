...
public class PsiFirestoreRulesTernaryTruePartImpl extends ASTWrapperPsiElement implements PsiFirestoreRulesTernaryTruePart {

  public PsiFirestoreRulesTernaryTruePartImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiFirestoreRulesVisitor visitor) {
    visitor.visitTernaryTruePart(this);
  }
