...
public class PsiFirestoreRulesVariableNameImpl extends ASTWrapperPsiElement implements PsiFirestoreRulesVariableName {

  public PsiFirestoreRulesVariableNameImpl(@NotNull ASTNode node) {
    super(node);
  }
