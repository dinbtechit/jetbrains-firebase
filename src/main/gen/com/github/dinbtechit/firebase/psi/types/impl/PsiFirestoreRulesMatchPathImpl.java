...
public class PsiFirestoreRulesMatchPathImpl extends ASTWrapperPsiElement implements PsiFirestoreRulesMatchPath {

  public PsiFirestoreRulesMatchPathImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiFirestoreRulesVisitor visitor) {
    visitor.visitMatchPath(this);
  }
