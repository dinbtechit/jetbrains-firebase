...
public class PsiFirestoreRulesVersionDefImpl extends ASTWrapperPsiElement implements PsiFirestoreRulesVersionDef {

  public PsiFirestoreRulesVersionDefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiFirestoreRulesVisitor visitor) {
    visitor.visitVersionDef(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getRulesVersion() {
    return findNotNullChildByType(RULES_VERSION);
  }
