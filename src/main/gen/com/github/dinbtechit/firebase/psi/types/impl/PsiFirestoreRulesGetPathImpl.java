...
public class PsiFirestoreRulesGetPathImpl extends ASTWrapperPsiElement implements PsiFirestoreRulesGetPath {

  public PsiFirestoreRulesGetPathImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiFirestoreRulesVisitor visitor) {
    visitor.visitGetPath(this);
  }
