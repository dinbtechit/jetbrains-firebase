...
public class PsiFirestoreRulesReturnStmtImpl extends ASTWrapperPsiElement implements PsiFirestoreRulesReturnStmt {

  public PsiFirestoreRulesReturnStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<PsiFirestoreRulesReturnStmtElements> getReturnStmtElementsList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, PsiFirestoreRulesReturnStmtElements.class);
  }
