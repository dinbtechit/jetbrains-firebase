...
public class PsiFirestoreRulesJsonValueImpl extends ASTWrapperPsiElement implements PsiFirestoreRulesJsonValue {

  public PsiFirestoreRulesJsonValueImpl(@NotNull ASTNode node) {
    super(node);
  }
