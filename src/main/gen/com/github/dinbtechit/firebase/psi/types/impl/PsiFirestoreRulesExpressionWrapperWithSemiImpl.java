...
public class PsiFirestoreRulesExpressionWrapperWithSemiImpl extends ASTWrapperPsiElement implements PsiFirestoreRulesExpressionWrapperWithSemi {

  public PsiFirestoreRulesExpressionWrapperWithSemiImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiFirestoreRulesVisitor visitor) {
    visitor.visitExpressionWrapperWithSemi(this);
  }
  ...
  public PsiFirestoreRulesExpressionWrapper getExpressionWrapper() {
    return findNotNullChildByClass(PsiFirestoreRulesExpressionWrapper.class);
  }
