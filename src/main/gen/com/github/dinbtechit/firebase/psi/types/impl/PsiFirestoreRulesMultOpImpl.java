...
public class PsiFirestoreRulesMultOpImpl extends ASTWrapperPsiElement implements PsiFirestoreRulesMultOp {

  public PsiFirestoreRulesMultOpImpl(@NotNull ASTNode node) {
    super(node);
  }
