...
public class PsiFirestoreRulesServiceBodyImpl extends ASTWrapperPsiElement implements PsiFirestoreRulesServiceBody {

  public PsiFirestoreRulesServiceBodyImpl(@NotNull ASTNode node) {
    super(node);
  }
