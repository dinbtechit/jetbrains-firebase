...
public class PsiFirestoreRulesBlockCommentRuleImpl extends ASTWrapperPsiElement implements PsiFirestoreRulesBlockCommentRule {

  public PsiFirestoreRulesBlockCommentRuleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiFirestoreRulesVisitor visitor) {
    visitor.visitBlockCommentRule(this);
  }
